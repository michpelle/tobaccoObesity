...
```{r table2, warning=FALSE, message=FALSE, echo=FALSE, results='asis'}
...
```{r resultRegression, message=FALSE, warning=FALSE, echo=FALSE, results='asis'}
...
```{r resultFirstStageReduced, message=FALSE, warning=FALSE, echo=FALSE, results='asis'}
